...
- Conclusion:
  Add an option to save CAD exchange STEP via browser-side `FACETED_BREP_SHAPE_REPRESENTATION` output using OFF meshes derived from the `single_material_shape` target.
- Reason:
