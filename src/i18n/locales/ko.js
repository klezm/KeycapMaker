const ko = Object.freeze({
  language: {
    ...
    options: {
    keysetLayout: {
      "iso-105": "ISO 105키(풀사이즈)",
      "ansi-104": "ANSI 104키(풀사이즈)",
    },
    keysetLanguage: {
      de: "독일어",
      us: "영어(US)",
  ...
  panels: {
    ...
    keyset: {
      title: "키셋",
      body: "키보드 한 대 분량의 키캡을 한 번에 렌더링하고, 하나 또는 두 개의 언어로 하나의 3MF로 내보냅니다.",
    },
  },
  keyset: {
    settingsTitle: "레이아웃 및 언어",
    buildTitle: "빌드",
    exportTitle: "내보내기",
    layout: {
      label: "키보드 레이아웃",
      hint: "생성할 물리적 키 배열입니다.",
    },
    primaryLanguage: {
      label: "주 언어",
      hint: "각 키캡의 기본 각인입니다.",
    ...
    secondaryLanguage: {
      label: "보조 언어",
      hint: "오른쪽 아래에 작게 들어가는 두 번째 문자 체계의 각인입니다.",
    },
    secondaryNone: "없음",
    shineThrough: {
      label: "투광 각인",
      hint: "각인을 상단까지 관통시켜 백라이트가 비치도록 합니다. 삽입 부품은 반투명 소재로 출력하세요.",
    },
    build: "키셋 빌드",
    cancel: "취소",
    exportBody: "위에서 이미 렌더링한 키캡을 내보내므로 다시 기다릴 필요가 없습니다.",
    exportBoard: "3MF(키보드 배열)",
    exportGrid: "3MF(출력 플레이트)",
    statusPreparing: "{count}개의 키캡을 준비하는 중...",
    statusRendering: "{total}개 중 {done}개의 파트를 렌더링하는 중...",
    statusReady: "완료: 키캡 {count}개({summary}).",
    statusCancelled: "빌드를 취소했습니다.",
    statusFailed: "빌드에 실패했습니다.",
    statusStale: "설정이 변경되었습니다. 키셋을 빌드하세요.",
    statusExported: "키캡 {count}개를 내보냈습니다.",
  },
  mobileInspector: {
    hide: "디자인 카드를 위로 숨기기",
    show: "디자인 카드 되돌리기",
