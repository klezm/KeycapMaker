const ja = Object.freeze({
  language: {
    ...
    options: {
    keysetLayout: {
      "iso-105": "ISO 105キー（フルサイズ）",
      "ansi-104": "ANSI 104キー（フルサイズ）",
    },
    keysetLanguage: {
      de: "ドイツ語",
      us: "英語（US）",
  ...
  panels: {
    ...
    keyset: {
      title: "キーセット",
      body: "キーボード1台分のキーキャップを一度にレンダリングし、1つまたは2つの言語で1つの3MFとして書き出します。",
    },
  },
  keyset: {
    settingsTitle: "レイアウトと言語",
    buildTitle: "ビルド",
    exportTitle: "書き出し",
    layout: {
      label: "キーボードレイアウト",
    ...
    primaryLanguage: {
      label: "主言語",
      hint: "各キーキャップのメインの印字です。",
    },
    secondaryLanguage: {
      label: "副言語",
      hint: "右下に小さく入る2つ目の文字体系の印字です。",
    },
    secondaryNone: "なし",
    shineThrough: {
      label: "シースルー印字",
      hint: "印字を天面まで貫通させ、バックライトを透過させます。差し込み部品は透過素材で印刷してください。",
    },
    build: "キーセットをビルド",
    cancel: "キャンセル",
    exportBody: "上でレンダリング済みのキーキャップを書き出すため、待ち時間はありません。",
    exportBoard: "3MF（キーボード配列）",
    exportGrid: "3MF（印刷プレート）",
    statusPreparing: "{count}個のキーキャップを準備しています...",
    statusRendering: "{total}個中{done}個のパーツをレンダリング中...",
    statusReady: "完了：{count}個のキーキャップ（{summary}）。",
    statusCancelled: "ビルドを中止しました。",
    statusFailed: "ビルドに失敗しました。",
    statusStale: "設定が変更されました。キーセットをビルドしてください。",
    statusExported: "{count}個のキーキャップを書き出しました。",
  },
  mobileInspector: {
    hide: "設計カードを上へしまう",
    show: "設計カードを戻す",
