const zh = Object.freeze({
  ...
  project: {
    ...
    importLabel: "粘贴项目 JSON",
    importPlaceholder: "在此粘贴项目 JSON 文件的内容",
    importPaste: "从剪贴板粘贴",
    importUpload: "选择文件",
    importApply: "载入项目",
    importing: "正在载入项目",
    importEmpty: "请先粘贴项目 JSON。",
    importNotBundle: "这不是 KeycapMaker 的项目 JSON。",
    importFailed: "无法载入项目：{message}",
    savedJson: "已保存项目 JSON（{byteLength} 字节）",
    copying: "正在复制项目 JSON",
    copiedJson: "已将项目 JSON 复制到剪贴板（{byteLength} 字节）",
    copyFailed: "无法复制项目 JSON：{message}",
    pasted: "已粘贴剪贴板内容",
    pasteFailed: "无法读取剪贴板：{message}",
    templatesTitle: "键盘模板",
    templatesHint: "使用当前的形状和颜色，为每个按键创建一个键帽的新项目。",
    templateBuilding: "正在创建 {name}",
    templateProgress: "正在创建 {name}（{done}/{total}）",
    templateLoaded: "已载入 {name}（{count} 个键帽）",
    templateFailed: "无法创建模板：{message}",
    templateReplaceConfirm: "这会替换当前项目（{count} 个键帽）。要继续吗？",
    templates: {
  ...
  importExport: {
    copied: "已复制 {byteLength} 字节到剪贴板",
    copiedBase64: "已以 Base64 形式复制 {byteLength} 字节到剪贴板",
    copyLabel: "复制到剪贴板",
    copyFailed: "无法复制到剪贴板",
    copyFailedLabel: "复制失败",
    copyTextNote: "已复制 {characters} 个字符的纯文本",
    copyBase64Note: "已复制 {characters} 个 Base64 字符。解码后即可还原为文件。",
