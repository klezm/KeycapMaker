const en = Object.freeze({
  ...
  project: {
    ...
    copyJson: "Copy Project JSON",
    importJson: "Import Project JSON",
    importLabel: "Paste project JSON",
    importPlaceholder: "Paste the contents of a project JSON file here",
    importPaste: "Paste from clipboard",
    importUpload: "Choose file",
    importApply: "Load project",
    importing: "Loading project",
    importEmpty: "Paste project JSON first.",
    importNotBundle: "This is not a KeycapMaker project JSON.",
    importFailed: "Failed to load the project: {message}",
    savedJson: "Saved project JSON ({byteLength} bytes)",
    copying: "Copying project JSON",
    copiedJson: "Copied project JSON to the clipboard ({byteLength} bytes)",
    copyFailed: "Failed to copy the project JSON: {message}",
    pasted: "Pasted clipboard contents",
    pasteFailed: "Failed to read the clipboard: {message}",
    templatesTitle: "Keyboard Templates",
    templatesHint: "Create a new project with one keycap per key, using the current shape and colors.",
    templateBuilding: "Building {name}",
    templateProgress: "Building {name} ({done}/{total})",
    templateLoaded: "Loaded {name} ({count} keycaps)",
    templateFailed: "Failed to build the template: {message}",
    templateReplaceConfirm: "This replaces the current project ({count} keycaps). Continue?",
    templates: {
  ...
  importExport: {
    copied: "Copied {byteLength} bytes to the clipboard",
    copiedBase64: "Copied {byteLength} bytes to the clipboard as Base64",
    copyLabel: "Clipboard Copy",
    copyFailed: "Failed to copy to the clipboard",
    copyFailedLabel: "Clipboard Copy Failed",
    copyTextNote: "Copied {characters} characters as plain text",
    copyBase64Note: "Copied {characters} Base64 characters. Decode them to restore the binary file.",
